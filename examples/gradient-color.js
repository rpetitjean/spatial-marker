        ...
        node.material = new THREE.ShaderMaterial({
          ...
          fragmentShader: `
            ...
            void main() {
              ...
              // Gradient between up to 6 colors (NO marble)
              vec3 gradientColor = multiGradient(wave);
